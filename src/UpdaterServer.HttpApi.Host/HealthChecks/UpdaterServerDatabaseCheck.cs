...
public class UpdaterServerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public UpdaterServerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
