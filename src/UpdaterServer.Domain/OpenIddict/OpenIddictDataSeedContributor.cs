...
namespace UpdaterServer.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("UpdaterServer") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "UpdaterServer", DisplayName = "UpdaterServer API", Resources = { "UpdaterServer" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["UpdaterServer_App:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["UpdaterServer_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["UpdaterServer_Swagger:RootUrl"]?.TrimEnd('/');
