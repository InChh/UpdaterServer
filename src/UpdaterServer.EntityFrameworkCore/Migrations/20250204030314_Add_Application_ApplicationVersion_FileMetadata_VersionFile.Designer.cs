...
{
    [DbContext(typeof(UpdaterServerDbContext))]
    [Migration("20250204030314_Add_Application_ApplicationVersion_FileMetadata_VersionFile")]
    partial class Add_Application_ApplicationVersion_FileMetadata_VersionFile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UpdaterServer.Application.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppApplications", "UpdaterServer");
                });

            modelBuilder.Entity("UpdaterServer.ApplicationVersion.ApplicationVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppApplicationVersions", "UpdaterServer");
                });

            modelBuilder.Entity("UpdaterServer.File.FileMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFileMetadatas", "UpdaterServer");
                });

            modelBuilder.Entity("UpdaterServer.File.VersionFile", b =>
                {
                    ...
                    b.HasKey("VersionId", "FileMetadataId");

                    b.HasIndex("ApplicationVersionId");

                    b.HasIndex("FileMetadataId");

                    b.HasIndex("VersionId", "FileMetadataId");

                    b.ToTable("AppVersionFiles", "UpdaterServer");
                });
            ...
            modelBuilder.Entity("UpdaterServer.ApplicationVersion.ApplicationVersion", b =>
                {
                    b.HasOne("UpdaterServer.Application.Application", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UpdaterServer.File.VersionFile", b =>
                {
                    b.HasOne("UpdaterServer.ApplicationVersion.ApplicationVersion", null)
                        .WithMany("Files")
                        .HasForeignKey("ApplicationVersionId");

                    b.HasOne("UpdaterServer.File.FileMetadata", null)
                        .WithMany()
